...
export async function GET() {
  try {
    ...
    const config = {
      hero_image_url: (!configRow?.hero_image_url || configRow.hero_image_url === "/images/about.png" || configRow.hero_image_url === "/images/hero-devi.png") ? "https://res.cloudinary.com/woo94xq2/video/upload/v1783348864/dhara_foundations/videos/injjcsbcbzokjavsswoc.mp4" : configRow.hero_image_url,
